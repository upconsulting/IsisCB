...
class TestBookChapters(TestCase):
    ...
    def test_process_bookchapters(self):
        ...
        isbn_type = LinkedDataType.objects.create(name='ISBN')
        LinkedData.objects.create(universal_resource_name='978-3-11-022578-4',
