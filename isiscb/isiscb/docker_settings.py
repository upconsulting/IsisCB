...
LOGGING = {
	...
	"handlers": {
		"app_analyzer": {
			...
			"filename": "/app/logs/app_analyzer.log",
			"formatter": "verbose",
		}
	},
	"loggers": {
...
WIKIPEDIA_EXPLORE_USERAGENT = "Explore Bibliography/1.0 (https://data.isiscb.org/)"
...
DEFAULT_TENANT = os.environ.get('DEFAULT_TENANT', 'isis')