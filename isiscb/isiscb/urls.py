...
urlpatterns = [
    ...
    re_path(r'^history/saved/delete[/]+$', saved_search_views.delete_all_saved_searches, name='delete_all_saved'),
    ...
    re_path(r'^history/search/(?P<pk>[0-9]+[^/]+)/delete$', saved_search_views.delete_search_object, name='delete_search_object'),
