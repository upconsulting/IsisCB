...
class ACRelation(ReferencedEntity, CuratedMixin):
    ...
    TYPE_CATEGORY_PUB_DISTR = [PUBLISHER, SCHOOL, PERIODICAL, MAINTAINING_INSTITUTION, PRESENTING_GROUP, HOST, DISTRIBUTOR, ARCHIVAL_REPOSITORY]
    ...
    INSTITUTIONAL_HOST_TYPES = [PUBLISHER, SCHOOL, INSTITUTION, MEETING]
    PUBLICATION_HOST_TYPES = [PERIODICAL, BOOK_SERIES, MAINTAINING_INSTITUTION, PRESENTING_GROUP, HOST, DISTRIBUTOR, ARCHIVAL_REPOSITORY]
