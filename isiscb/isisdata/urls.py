...
urlpatterns = [
    ...
    url(r'^user/(?P<username>[^/]+)/collections/$', views.user_collections, name='user_collections'),
    url(r'^collection/(?P<collection_id>[0-9]+)/$', views.collection, name='collection'),
    url(r'^collection/(?P<collection_id>[0-9]+)/csv/$', views.generate_csv_from_collection, name='generate_csv_from_collection'),
