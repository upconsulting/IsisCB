...
urlpatterns = [
    ...
    url(r'^user/(?P<username>[^/]+)/playlists/$', views.user_playlists, name='user_playlists'),
    url(r'^playlist/(?P<collection_id>[0-9]+)/$', views.playlist, name='playlist'),
    url(r'^playlist/(?P<collection_id>[0-9]+)/csv/$', views.generate_csv_from_playlist, name='generate_csv_from_playlist'),
    url(r'^playlist/addcitation/$', views.add_citations_to_playlist, name='add_citations_to_playlist'),
    url(r'^playlist/removecitation/$', views.remove_citation_from_playlist, name='remove_citation_from_playlist'),
    url(r'^playlist/addsubject/$', views.quick_create_aprelation, name='quick_create_aprelation'),
    url(r'^playlist/deletesubject/$', views.quick_delete_aprelation, name='quick_delete_aprelation'),
    url(r'^user/(?P<username>[^/]+)/addinterest/$', views.quick_create_aurelation, name='quick_create_aurelation'),
    url(r'^user/(?P<username>[^/]+)/deleteinterest/$', views.quick_delete_aurelation, name='quick_delete_aurelation'),
