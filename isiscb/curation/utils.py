...
def _format_contributors(citation): 
    ...
    if contribs:
        ...
        # if 2 contributors: "LASTNAME1, Firstname1 and Firstname2 LASTNAME2."
        elif len(contribs) == 2:
            formatted_contributors = formatted_contributors + 'and ' + _build_name_first_last_html(contribs[1]) + '.'
        # if 2 contributors: "LASTNAME1, Firstname1, Firstname2 LASTNAME2, and Firstname3 LASTNAME3."
        elif len(contribs) == 3:
        ...
        # if more than 3 contributors: "LASTNAME1, Firstname1, Firstname2 LASTNAME2, Firstname3 LASTNAME3, et al."
        elif len(contribs) > 3:
...
def _format_publisher_or_periodical(citation):
    ...
    if citation.type_controlled == Citation.THESIS:
        ...
        if schools:
            return 'Dissertation at ' + schools[0].authority.name
    if periodicals:
