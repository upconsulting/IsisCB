...
ALLOWED_FIELDS = {
    ...
    CCRelation: ['subject_id', 'object_id', 'name', 'description', 'type_controlled', 'belongs_to', 'data_display_order', 'administrator_notes', 'record_status_value', 'record_status_explanation']
}
